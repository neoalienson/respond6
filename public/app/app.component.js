System.register(['angular2/core', 'angular2/router', './login/login.component', './forgot/forgot.component', './reset/reset.component', './create/create.component', './pages/pages.component', './files/files.component', './users/users.component', './menus/menus.component', './forms/forms.component', './branding/branding.component'], function(exports_1, context_1) {
    ...
    var core_1, router_1, login_component_1, forgot_component_1, reset_component_1, create_component_1, pages_component_1, files_component_1, users_component_1, menus_component_1, forms_component_1, branding_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.RouteConfig([
                        ...
                        },
                        {
                            path: '/branding',
                            name: 'Branding',
                            component: branding_component_1.BrandingComponent
                        }
                    ]), 
