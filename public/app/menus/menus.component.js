System.register(['angular2/core', 'angular2-jwt/angular2-jwt', 'angular2/router', '/app/shared/services/menu.service', '/app/shared/services/menu-item.service', '/app/shared/components/add-menu/add-menu.component', '/app/shared/components/edit-menu/edit-menu.component', '/app/shared/components/remove-menu/remove-menu.component', '/app/shared/components/add-menu-item/add-menu-item.component', '/app/shared/components/edit-menu-item/edit-menu-item.component', '/app/shared/components/remove-menu-item/remove-menu-item.component', '/app/shared/components/drawer/drawer.component'], function(exports_1, context_1) {
    "use strict";
